    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Field>(entity =>
            {
                ...
                entity.Property(e => e.IdEosField).HasColumnName("ID_EOS_FIELD");
                entity.Property(e => e.NmField).HasColumnName("NM_FIELD").HasMaxLength(100).IsRequired();
                entity.Property(e => e.VlAreaHectare).HasColumnName("VL_AREA_HECTARE").HasColumnType("NUMBER(10,2)");
